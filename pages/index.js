...
const bio = `<p>
<strong>Hello! I’m Begoña Buxens.</strong> From the earliest days of my childhood,
 my mother instilled in me the values of independence and passion.
 Her teachings were not just words, they were the essence of her spirit.
 My mother got her PHD in Philosophy when I was in High School, with four children.
 She taught me to stand on my own feet, to face the world with courage and self-relience.
 "Don't depend on anyone" she would say.  She encourage me to chase my dreams without restrain.  In her eyes, freedom was not just a right, but a necessity- the vital breath of life that fuels one's journey towards self-discovery and fulfillmet. Her lessons became my compass, guiding me thrugh life's twist and turns with a spirit of independence and a heart ablaze with passion.
</p>`
const serviceList = [
  {
...
const headerMenus = [
  ...
  { title: "Album", link: "works", icon: "icon ion-disc" },
  { title: "Blog", link: "blog", icon: "icon ion-chatbox-working" },
  { title: "Contact", link: "contacts", icon: "icon ion-at" },
];

const animationText = ["Software Engineer in progress", "Translator", "Instructor"];
    ...
    <Layout bg={"regular"}>
      ...
      <Home>
        <div className="profile no-photo">
          ...
          />
          {/* profile titles */}
          <div className="title">Begoña Buxens</div>
