      ...
      <div className="row">
        ...
        <div className="col col-d-12 col-t-12 col-m-12 border-line-v">
          <div className="skills-list">
            <ul>
              <li className="border-line-h">
                <div className="name">Skilled communicator with a focus on tailoring messages to resonate with diverse audiences; track record of success
synthesizing and presenting technical information in clear and concise ways.</div>
                {/* <div className="progress">
                  <div className="percentage" style={{ width: "90%" }} />
                </div> */}
              </li>
        ...
        <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
          <div className="skills-list list">
            ...
            <ul>
              <li>
                <div className="name">Skilled communicator</div>
              </li>
              <li>
                <div className="name">Fluent in Spanish and English</div>
              </li>
              <li>
                <div className="name">Coaching & Mentoring</div>
              </li>
              <li>
                <div className="name">Event Management</div>
              </li>
              <li>
                <div className="name">Data Analysis & Reporting</div>
              </li>
              <li>
                <div className="name">Collaboration Cultural Competency</div>
              </li>
            </ul>
          </div>
        </div>
